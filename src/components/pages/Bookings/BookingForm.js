...
const BookinForm = ({ availableTimes, dispatchOnDateChange, submitData }) => {
  ...
  const invalidOccasionErrorMessage = 'Please choose a valid occassion';
